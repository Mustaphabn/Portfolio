    ...
    <div className='relative flex items-center justify-center h-auto w-full 
            ...
            group hover:bg-gradient-to-r from-[#5651e5] to-[#709dff]  '>
                ...
                <div className='hidden group-hover:block absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]'>
                    ...
                    <p className='pb-4 pt-2 text-white tracking-wider '>{tech}</p>
                    <Link href={projectUrl}>
                        <p className='text-center py-3 rounded-lg bg-white text-gray-700 font-bold
                        text-lg cursor-pointer'>More Info</p>
                    </Link>
                </div>
            </div>
  )
